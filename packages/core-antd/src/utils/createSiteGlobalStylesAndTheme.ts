...
import { getAntdVariables } from './getAntdVariables';

export function createSiteGlobalStylesAndTheme(paletteLess: string) {
  const theme: Theme = getAntdVariables(paletteLess);
